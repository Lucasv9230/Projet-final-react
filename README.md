...
Le build de production est généré par `npm run build` dans `dist/`. Aucun déploiement HTTPS public n'est configuré dans ce dépôt ; ce bonus reste donc à réaliser sur une plateforme comme Vercel, Netlify ou GitHub Pages.
